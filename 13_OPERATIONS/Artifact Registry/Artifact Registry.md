...
related_documents: ["[[13_OPERATIONS]]", "[[ALPHA PROXIMA ENGINEERING HANDBOOK]]"]
...
| Research Commission | Request for research work | Research Office / commissioning office | Research governance process | draft -> commissioned -> converted -> archived | `14_FUTURE/Research Commissions/` or future research intake | Commission ID |
...
| Future Proposal | Preserved future idea | Future Office | Routing authority by destination | draft -> review_queue -> routed -> archived | `14_FUTURE/` | Future ID and version |
| Strategic Review | Strategy and priority review | Executive Office / Strategy | Founder or relevant office | draft -> reviewed -> actioned -> archived | `02_STRATEGY/` or `13_OPERATIONS/` | Review period versioning |
| Operational Procedure | Repeatable operating process | Operations Layer | Relevant office owner | draft -> active -> revised -> archived | `13_OPERATIONS/Operational Procedures/` | Semantic versioning |
...
| Operational Health Report | Health and risk summary | Institutional Observatory / Engineering | Report-only unless escalated | generated -> reviewed -> routed -> archived | `13_OPERATIONS/Operational Health/` | Dated reports |
