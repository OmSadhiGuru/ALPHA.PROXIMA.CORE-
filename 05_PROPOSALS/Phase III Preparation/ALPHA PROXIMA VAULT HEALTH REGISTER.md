...
| H9 | **Folder numbering collisions** | Historical: `06_GOVERNANCE`+`06_PROJECTS`; `09_OFFICES`+`09_FUTURE` | resolved by `11_PROJECTS`, `12_PEOPLE`, `13_OPERATIONS`, `14_FUTURE` | ✅ | One canonical folder per reserved number | Founder-ratified migrations recorded in the Vault Structure Convention | 2026-09-02 | ✅ resolved |
...
| H12 | **Empty strategy & project layers** | `02_STRATEGY/` + `11_PROJECTS/` = only `.gitkeep` | those folders | 🟠 | No vision→execution bridge; projects can't prove alignment | Build cascade per Strategy Blueprint | Meta-Layer + Blueprint | ⚠️ YELLOW |
