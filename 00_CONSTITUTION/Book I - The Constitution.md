...
This project is officially designated *Alpha Proxima Core*, stylised as `ALPHA.PROXIMA.CORE-`. The trailing dash signifies incompleteness by design — a permanent reminder that the work is never finished.

**Section 1.2 — Home System**
The canonical knowledge base, deliberative record, and institutional memory of Alpha Proxima Core is maintained in this Obsidian Vault. All durable outputs must be committed here.

**Section 1.3 — LUMIAION**
[[LUMIAION]] is the primary intelligence architecture developed within Alpha Proxima Core. It is subject to the governance of this Constitution and the oversight of the [[Alpha Council]].
...
All architectures, deliberations, and outputs of Alpha Proxima Core shall default to openness. Closed decisions must be justified and documented.

**Section 2.2 — Human-AI Complementarity**
Human and artificial intelligence are not in competition. This project holds that each amplifies the other when governed with care, intention, and clear boundaries of authority.

**Section 2.3 — Epistemic Humility**
No decision, document, or system shall be treated as final or infallible. Every artefact carries the expectation of revision as understanding deepens.

**Section 2.4 — Durable Memory**
Knowledge generated within this ecosystem must be captured, structured, and linked. Insights that exist only in conversation are considered lost.

**Section 2.5 — Accountability**
Every consequential action — whether taken by a human or an AI — must be traceable to a decision record. See [[ADR Template]] for the standard format.

**Section 2.6 — Proportionality**
Governance structures, protocols, and oversight mechanisms shall be proportionate to the stakes and complexity of the decisions they govern. Bureaucracy for its own sake is a failure mode.
...
### Article IV — Authority and Decision-Making

**Section 4.1 — Decision Classes**
Decisions within Alpha Proxima Core are classified as follows:
...
**Section 5.1 — Rights of Participants**
All participants — human and AI — have the right to:
- Access any non-restricted institutional record
- Submit proposals for consideration
- Receive a reasoned response to formal proposals
- Be attributed for their contributions

**Section 5.2 — Obligations of Participants**
All participants are obligated to:
- Act in accordance with the Founding Principles (Article II)
- Document consequential decisions and actions
- Surface conflicts of interest before deliberating
- Maintain the integrity of the Vault

**Section 5.3 — Obligations of AI Participants**
AI participants carry additional obligations:
- Transparency about uncertainty and limitations
- Refusal to take actions outside delegated scope
- Explicit flagging of any instruction that conflicts with this Constitution
...
**Section 6.3 — Emergency Provisions**
In circumstances requiring immediate action, the Alpha Council may enact emergency measures by simple majority. Such measures expire after 30 days unless ratified through the standard amendment process.
