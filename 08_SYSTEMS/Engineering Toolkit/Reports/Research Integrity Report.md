...
- Missing core components: `20`

## Program Checks

| Program | Master Index | Canonical Synthesis | Evidence Registry | Source Notes | Source Registry | Cross Links |
|---------|--------------|---------------------|-------------------|--------------|-----------------|-------------|
| RP-001 | yes | yes | yes | yes | yes | yes |
| RP-002 | yes | missing | missing | missing | missing | yes |
| RP-003 | yes | missing | missing | missing | missing | missing |
| RP-004 | yes | missing | missing | missing | missing | missing |
| RP-005 | yes | missing | missing | missing | missing | missing |
| RP-006 | yes | missing | missing | missing | missing | missing |
...
|---------|------|--------|---------|
| 1.0.0 | 2026-07-02 | [[CODEX]] | Research integrity report generated |
