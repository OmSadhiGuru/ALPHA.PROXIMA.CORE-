...
|------|-------------|--------|------------|---------------------|
| `PART_OF` | `07_RESEARCH/RP-001/00 Executive Summary/RP-001 Executive Summary.md` | `07_RESEARCH/RP-001/RP-001 Master Index.md` | `0.55` | `folder_inference` |
...
| `PART_OF` | `07_RESEARCH/RP-001/02 Objectives/RP-001 Objectives.md` | `07_RESEARCH/RP-001/RP-001 Master Index.md` | `0.55` | `folder_inference` |
...
| `PART_OF` | `07_RESEARCH/RP-001/05 Source - Gemini/RP-001 Source Note - Gemini.md` | `07_RESEARCH/RP-001/RP-001 Master Index.md` | `0.55` | `folder_inference` |
...
| `PART_OF` | `07_RESEARCH/RP-001/10 Theory Matrix/RP-001 Theory Matrix.md` | `07_RESEARCH/RP-001/RP-001 Master Index.md` | `0.55` | `folder_inference` |
...
| `SUPPORTS` | `07_RESEARCH/RP-001/12 Evidence Registry/RP-001 Evidence Registry.md` | `07_RESEARCH/RP-001/09 Canonical Synthesis/RP-001 Canonical Synthesis.md` | `0.45` | `wiki_link` |
| `PART_OF` | `07_RESEARCH/RP-001/13 Research Graph/Concepts/4E Cognition.md` | `07_RESEARCH/RP-001/RP-001 Master Index.md` | `0.55` | `folder_inference` |
...
| `PART_OF` | `07_RESEARCH/RP-001/13 Research Graph/Concepts/Attention Schema Theory.md` | `07_RESEARCH/RP-001/RP-001 Master Index.md` | `0.55` | `folder_inference` |
...
| `PART_OF` | `07_RESEARCH/RP-001/13 Research Graph/Concepts/Higher-Order Thought Theory.md` | `07_RESEARCH/RP-001/RP-001 Master Index.md` | `0.55` | `folder_inference` |
...
| `PART_OF` | `07_RESEARCH/RP-001/13 Research Graph/Concepts/Meta Awareness.md` | `07_RESEARCH/RP-001/RP-001 Master Index.md` | `0.55` | `folder_inference` |
...
| `PART_OF` | `07_RESEARCH/RP-001/15 Future Experiments/RP-001 Future Research Opportunities.md` | `07_RESEARCH/RP-001/RP-001 Master Index.md` | `0.55` | `folder_inference` |
...
| `PART_OF` | `07_RESEARCH/RP-001/17 NotebookLM Package/RP-001 NotebookLM Source Pack.md` | `07_RESEARCH/RP-001/RP-001 Master Index.md` | `0.55` | `folder_inference` |
...
| `PART_OF` | `07_RESEARCH/RP-001/19 Related Laws/RP-001 Governing Provisions.md` | `07_RESEARCH/RP-001/RP-001 Master Index.md` | `0.55` | `folder_inference` |
...
| `PART_OF` | `07_RESEARCH/RP-001/ARCHIVE/ARCHIVE Philosophy.md` | `07_RESEARCH/RP-001/RP-001 Master Index.md` | `0.55` | `folder_inference` |
...
| `PART_OF` | `08_SYSTEMS/Engineering Toolkit/Tool 006 - Office Integrity Checker.md` | `08_SYSTEMS/Engineering Toolkit/Alpha Proxima Engineering Toolkit.md` | `0.55` | `folder_inference` |
...
| `PRODUCED_BY` | `03_AI_COUNCIL/Departments/JERANIUM Charter.md` | `Alpha Proxima Foundation` | `yaml_field` | `authors` |
| `PRODUCED_BY` | `03_AI_COUNCIL/Departments/LUMIAION Charter.md` | `Alpha Proxima Foundation` | `yaml_field` | `authors` |
| `PRODUCED_BY` | `03_AI_COUNCIL/Departments/SOHMA Charter.md` | `Alpha Proxima Foundation` | `yaml_field` | `authors` |
...
| `REFERENCES` | `07_RESEARCH/RP-001/00 Executive Summary/RP-001 Executive Summary.md` | `ARCHIVE` | `wiki_link` | `` |
| `OWNED_BY` | `07_RESEARCH/RP-001/09 Canonical Synthesis/RP-001 Canonical Synthesis.md` | `Alpha Proxima Foundation` | `yaml_field` | `institutional_owner` |
...
| `OWNED_BY` | `08_SYSTEMS/Engineering Standards/04 - File Naming Convention.md` | `Alpha Proxima Foundation` | `yaml_field` | `institutional_owner` |
...
| `REFERENCES` | `08_SYSTEMS/Engineering Toolkit/Tool 003 - Metadata Migration Utility.md` | `Metadata Migration Plan v1.0` | `wiki_link` | `` |
| `RELATED_TO` | `08_SYSTEMS/Engineering Toolkit/Tool 003 - Metadata Migration Utility.md` | `[[Metadata Migration Plan v1.0]]` | `yaml_field` | `related_documents` |
...
| `REFERENCES` | `08_SYSTEMS/Engineering Toolkit/Tool 004 - Vault Statistics Generator.md` | `Engineering Dashboard Report` | `wiki_link` | `` |
| `RELATED_TO` | `08_SYSTEMS/Engineering Toolkit/Tool 004 - Vault Statistics Generator.md` | `[[Engineering Dashboard Report]]` | `yaml_field` | `related_documents` |
...
| `REFERENCES` | `08_SYSTEMS/Engineering Toolkit/Tool 005 - Dependency Analyzer.md` | `Vault Dependency Report` | `wiki_link` | `` |
| `RELATED_TO` | `08_SYSTEMS/Engineering Toolkit/Tool 005 - Dependency Analyzer.md` | `[[Vault Dependency Report]]` | `yaml_field` | `related_documents` |
...
| `REFERENCES` | `08_SYSTEMS/Engineering Toolkit/Tool 006 - Office Integrity Checker.md` | `Office Integrity Report` | `wiki_link` | `` |
| `RELATED_TO` | `08_SYSTEMS/Engineering Toolkit/Tool 006 - Office Integrity Checker.md` | `[[Office Integrity Report]]` | `yaml_field` | `related_documents` |
...
| `OWNED_BY` | `08_SYSTEMS/Engineering Toolkit/Tool 006 - Office Integrity Checker.md` | `Alpha Proxima Foundation` | `yaml_field` | `institutional_owner` |
| `REFERENCES` | `08_SYSTEMS/Engineering Toolkit/Tool 007 - Research Integrity Checker.md` | `Research Integrity Report` | `wiki_link` | `` |
| `RELATED_TO` | `08_SYSTEMS/Engineering Toolkit/Tool 007 - Research Integrity Checker.md` | `[[Research Integrity Report]]` | `yaml_field` | `related_documents` |
...
| `REFERENCES` | `08_SYSTEMS/Institutional Knowledge Graph/Graph Readiness Assessment.md` | `Engineering Dashboard Report` | `wiki_link` | `` |
| `REFERENCES` | `08_SYSTEMS/Institutional Knowledge Graph/Graph Readiness Assessment.md` | `Vault Dependency Report` | `wiki_link` | `` |
...
| `OWNED_BY` | `08_SYSTEMS/Institutional Knowledge Graph/Graph Readiness Assessment.md` | `Alpha Proxima Foundation` | `yaml_field` | `institutional_owner` |
| `OWNED_BY` | `08_SYSTEMS/Institutional Knowledge Graph/Knowledge Graph Architecture v1.0.md` | `Alpha Proxima Foundation` | `yaml_field` | `institutional_owner` |
...
| `OWNED_BY` | `08_SYSTEMS/Institutional Knowledge Graph/Node Taxonomy.md` | `Alpha Proxima Foundation` | `yaml_field` | `institutional_owner` |
...
| `REFERENCES` | `08_SYSTEMS/Institutional Knowledge Graph/Tools/Relationship Registry Report.md` | `Engineering Dashboard Report` | `wiki_link` | `` |
| `REFERENCES` | `08_SYSTEMS/Institutional Knowledge Graph/Tools/Relationship Registry Report.md` | `Metadata Migration Plan v1.0` | `wiki_link` | `` |
| `REFERENCES` | `08_SYSTEMS/Institutional Knowledge Graph/Tools/Relationship Registry Report.md` | `Office Integrity Report` | `wiki_link` | `` |
| `REFERENCES` | `08_SYSTEMS/Institutional Knowledge Graph/Tools/Relationship Registry Report.md` | `Research Integrity Report` | `wiki_link` | `` |
| `REFERENCES` | `08_SYSTEMS/Institutional Knowledge Graph/Tools/Relationship Registry Report.md` | `Vault Dependency Report` | `wiki_link` | `` |
| `REFERENCES` | `08_SYSTEMS/Institutional Knowledge Graph/Tools/Relationship Registry Report.md` | `node_registry.json` | `wiki_link` | `` |
| `OWNED_BY` | `08_SYSTEMS/Institutional Knowledge Graph/Tools/Relationship Registry Report.md` | `Alpha Proxima Foundation` | `yaml_field` | `institutional_owner` |
| `REFERENCES` | `08_SYSTEMS/Institutional Knowledge Graph/Tools/Tool 010 - Node Registry Generator.md` | `node_registry.json` | `wiki_link` | `` |
| `RELATED_TO` | `08_SYSTEMS/Institutional Knowledge Graph/Tools/Tool 010 - Node Registry Generator.md` | `[[node_registry.json]]` | `yaml_field` | `related_documents` |
