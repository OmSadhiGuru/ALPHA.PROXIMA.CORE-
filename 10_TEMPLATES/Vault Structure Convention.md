...
│
├── 14_FUTURE/             ← Preserved future proposals and review queues
│                            Ideas remain non-canonical until formally promoted
│
...
| 1.3.0 | 2026-09-02 | Founder / CODEX | Founder-ratified `14_FUTURE`; preserve `09_OFFICES` and remove the remaining top-level number collision |
